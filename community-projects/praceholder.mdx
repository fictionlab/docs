...
description: Temporary placeholder for the first community project. Please refer to the https://docs.fictionlab.pl/guidelines/add-community-project for instructions on how to add a new community project.
authors:
  - name: Author Name
    title: Author Title
