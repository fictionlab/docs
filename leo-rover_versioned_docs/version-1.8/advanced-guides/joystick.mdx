---
title: How to Steer Leo Rover with a Joystick using ROS
sidebar_label: Steering with a joystick
sidebar_position: 5
keywords:
  - Leo Rover
  - ROS
  ...
  - remote control
description: >-
  Learn to control a Leo Rover with a joystick by creating a ROS package using
  joy_node and teleop_twist_joy to publish velocity commands.
image: /img/robots/leo/leo-rover-1.9.webp
---

# How to Steer with a Joystick
