---
title: ROS Development Guide for Leo Rover
...
keywords:
  ...
  - robot programming
description: >-
  Learn practical ROS development for the Leo Rover. This guide covers using
  command-line tools, writing nodes, building workspaces, and extending the
  URDF.
image: /img/robots/leo/guides/ros-development/sensor-rviz.webp
---
...
You should see the nodes described in the
[software structure](../documentation/specification#software-structure). Among
them, the rosserial server node (called `/serial_node` in this case) "bridges"
communication with the CORE2 board, so any topics it publishes or subscribes are
created and used in the firmware.
...
<LinkButton
  to="/leo-integrations/noetic/lidars/hokuyo-ug-04lx-ug01"
...
/>
<LinkButton
  to="/leo-integrations/noetic/legacy/grove-imu"
  title="Grove IMU"
...
[Connect to the Internet tutorial](../guides/connect-to-network)).
