---
title: How to Visualize the Leo Rover Model using RViz
sidebar_label: Visualizing in RViz
sidebar_position: 4
keywords:
  - Leo Rover
  - RViz
  ...
  - RobotModel
description: >-
  Learn to use RViz to display and interact with the Leo Rover's 3D model. This
  guide covers setup, launching, and both live and offline visualization.
image: /img/robots/leo/guides/rviz/rviz.webp
---
