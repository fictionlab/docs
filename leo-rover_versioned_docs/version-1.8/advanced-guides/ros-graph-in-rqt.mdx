---
title: 'RQT Tutorial: Visualizing the ROS Graph for Leo Rover'
...
keywords:
  ...
  - computation graph
description: >-
  Learn to use RQT to visualize the ROS computation graph of your Leo Rover, a
  powerful technique for debugging node and topic communication issues.
image: /img/robots/leo/guides/ros-graph-in-rqt/rqt-node-graph.webp
---

# How to Use RQT for ROS Graph Introspection
