---
title: Multi-Rover ROS Network Configuration for Leo Rover
sidebar_label: Multi-Rover ROS Setup
sidebar_position: 7
keywords:
  - Leo Rover
  - ROS
  ...
  - namespace
description: >-
  Learn how to configure multiple Leo Rovers on a single ROS network. This guide
  covers setting up a shared ROS master, namespaces, and unique TF trees.
image: /img/robots/leo/guides/connecting-rovers-together/ip-addr-bash.webp
---
