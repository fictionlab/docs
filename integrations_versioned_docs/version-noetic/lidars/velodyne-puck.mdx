...
[Universal Camera Mast](/leo-rover/1.8/addons/universal-camera-mast).
...
found [here](/leo-rover/1.8/addons/additional-meb-covers), provides a wide opening
...
provide an external power connection. [Powerbox](/leo-rover/1.8/addons/powerbox)
...
<robot>
    ...
    <joint name="velodyne_base_mount_joint" type="fixed">
      <origin xyz="0.0775 0 0"/> <!-- Add correct translation -->
...
[Integrations page](/integrations/noetic) for more instructions.
