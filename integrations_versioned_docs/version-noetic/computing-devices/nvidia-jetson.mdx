...
[here](/leo-rover/1.8/addons/additional-meb-covers), with an opening for the cable
can fit through.
...
[Powerbox addon](/leo-rover/1.8/addons/powerbox).
...
on [Autonomous Navigation](/leo-rover/1.8/advanced-guides/autonomous-navigation)
