...
Make sure that you have ROS sourced in your terminal before running any
commands. You can do this by running:

```bash
source /opt/ros/<your_distro>/setup.bash
```

Replace `<your_distro>` with `melodic` or `noetic` depending on your setup.
