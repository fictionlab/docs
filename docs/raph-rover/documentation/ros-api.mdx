...
keywords:
  ...
  - API
description: >-
  Comprehensive reference for the Raph Rover's ROS 2 API, detailing subscribed and
  published topics, available services, drivetrain parameters, and custom messages.
