...
- `controller/cmd_led_strip` ([raph_interfaces/msg/LedStripState])

  Sets a new user state for all the LEDs in the LED strip.

- `controller/cmd_led_panel` ([raph_interfaces/msg/LedPanelState])
...
- `controller/cmd_wheel_fl`, `controller/cmd_wheel_fr`,
  `controller/cmd_wheel_rl`, `controller/cmd_wheel_rr`
  ([raph_interfaces/msg/WheelCommand])

  Per-wheel commands for directly driving each wheel motor (front-left,
  front-right, rear-left, rear-right). Can be used for testing or custom control
  strategies.

- `controller/cmd_servo_l`, `controller/cmd_servo_r`
  ([raph_interfaces/msg/ServoCommand])

  Per-servo commands for directly controlling the left and right servo motors.
  Can be used for testing or custom control strategies.
...
[raph_interfaces/msg/ServoCommand]:
  https://docs.ros.org/en/jazzy/p/raph_interfaces/msg/ServoCommand.html
[raph_interfaces/msg/WheelCommand]:
  https://docs.ros.org/en/jazzy/p/raph_interfaces/msg/WheelCommand.html
