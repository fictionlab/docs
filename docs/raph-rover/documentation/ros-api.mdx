...
keywords:
  ...
  - api
description: >-
  Description of the ROS API for Raph Rover. Includes published topics,
...
<font color="red">
TODO:
    - ask Błażej to expand TODO list \<3
    </font>
...
- `controller/led_panel_state` ([raph_interfaces/msg/LedPanelState]) **Not
  implemented yet**
...
raph_interfaces/LedState[129] state
```
...
[raph_interfaces/msg/Led]: #msg-led [raph_interfaces/msg/LedColor]:
#msg-led-color [raph_interfaces/msg/LedPanel]: #msg-led-panel
