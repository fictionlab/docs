...
TODO:
    ...
    - Write something more getting-started specific (like "how to get started with
      your new rover, shit's easy yo:")
    - Replace images with ones with ones made with "assembly manual template"
    - remove all text that is found in overview
    - center all tables
    </font>

Raph Rover is a versatile platform designed for a wide range of robotic
...
Each Raph Rover is equipped with two dedicated 24V Li-Ion battery packs.
...
<ThemedImageZoom
  alt="Raph's battery removed and inserted"
  sources={{
    light: useBaseUrl(
      '/img/robots/raph/getting-started/battery-insertion-light.webp',
    ),
    dark: useBaseUrl(
      '/img/robots/raph/getting-started/battery-insertion-dark.webp',
    ),
  }}
  width="1500"
  height="777"
  ...
  caption="Raph's battery outside (left) and inside (right) the slot"
/>
...
<ThemedImageZoom
  ...
  sources={{
    light: useBaseUrl('/img/robots/raph/getting-started/buttons-light.webp'),
    dark: useBaseUrl('/img/robots/raph/getting-started/buttons-dark.webp'),
  }}
  width="750"
  height="575"
  figStyle={{
