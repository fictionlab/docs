...
<ThemedImageZoom
  ...
  sources={{
    ...
    dark: useBaseUrl('/img/robots/raph/specification/Overview_front_white.webp'),
  }}
  width="3000"
  height="2121"
  figStyle={{
...
<ThemedImageZoom
  ...
  sources={{
    ...
    dark: useBaseUrl('/img/robots/raph/specification/Overview_electronics_white.webp'),
  }}
  width="3000"
  height="2121"
  figStyle={{
...
<font color="red"> Please decide if last image is necessary - remove if not </font>
...
<ThemedImageZoom
  ...
  sources={{
    light: useBaseUrl(
      '/img/robots/raph/specification/Top_plate_black.webp',
    ),
    dark: useBaseUrl(
      '/img/robots/raph/specification/Top_plate_white.webp',
    ),
  }}
  width="3000"
  height="2121"
...
<ThemedImageZoom
  ...
  sources={{
    light: useBaseUrl(
      '/img/robots/raph/specification/Back_seals_black.webp',
    ),
    dark: useBaseUrl(
      '/img/robots/raph/specification/Back_seals_white.webp',
    ),
  }}
  width="3000"
  height="1428"
...
<font color="red" size="+2"> Do we still use them? </font>
