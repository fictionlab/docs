...
<font color="red" size="+3"> No one cares about what its tasks are</font>
...
<font color="red" size="+2"> An image is worth a 1000 words - remove text, replace with image showing the movement</font>
...
<font color="red" size="+3"> No one cares. 4 wheels, (size), (material), each with a motor, bldc outrunner, (motor power), motor torque. </font>
...
<font color="red" size="+3"> No one cares! w batteries inside the rover, hotswap ability, dedicated charger, ability to charge through rover, work time, volatge, max power draw, safety, Capacity (info that it's flight safe)</font>
...
<font color="red" size="+3"> No one will buy the rover because charging batteries is easy. Throw section out. + It's already in getting started</font>
...
<font color="red" size="+3"> Move way higher than it is right now - you buy the rover TO ATTACH PAYLOAD, This section is more important than wheel diameter</font>
...
v-slot extrusions of the Raph Rover. <font color="red" size=""> Effectively giving you (400)mm by (400)mm working area </font>
...
<font color="red" size="+2"> Skip the talk, straight to the table with ports </font>
...
<font color="red" size="+2"> That section is super long. Point out the best parts - throw the rest into guides / separate docs </font>
<br/>
<font color="red" size="+5"> DO NOT TALK ABOUT HOW ROS WORKS PLZ </font>
...
<font color="red" size="+2"> The moment you see this graph as a non technical guy trying to buy this rover your brain will fry </font>
