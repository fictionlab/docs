...
<font color="red" size="+2">
  {' '}
  Wywalić tą sekcję - zostawić to na pudełku albo stronie sklepu{' '}
</font>
...
<font color="red" size="+3">
  {' '}
  Move way higher than it is right now - you buy the rover TO ATTACH PAYLOAD,
  This section is more important than wheel diameter
</font>
...
| RJ-45      |     10/100/1000 Mbps      |     Teltonika RUTX10      |
| RJ-45      |     10/100/1000 Mbps      |     Teltonika RUTX10      |
...
<font color="red" size="+2">
  {' '}
  This section should probably be moved to the Hardware section{' '}
</font>
...
giving you (400)mm by (400)mm working area </font>

#### Additional mounting plates

<font color="red" size="+2">
  {' '}
  Throw this section away (preferably into an Addon section){' '}
</font>
...
<font color="red" size="+2"> THIS MIGHT ACTUALLY MAKE SOMEONE WANT TO BUY THE ROVER. Why is it hidden at the bottom</font>
<br/>
<font color="red"> Especially if we mention that any camera connected to the rover can be easily streamed to the UI</font>
