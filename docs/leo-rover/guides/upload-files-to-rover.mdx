---
title: How to Upload Files to Leo Rover (FTP, SCP, SSHFS)
sidebar_label: Upload Files to the Rover
sidebar_position: 6
keywords:
  - Leo Rover
  - upload files
  ...
  - WinSCP
description: >-
  A guide on how to transfer files to a Leo Rover using various methods,
  including WinSCP for Windows and scp or sshfs for Linux and macOS.
