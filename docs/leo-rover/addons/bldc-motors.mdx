...
{/* TODO: BLA BLA COŚ O TYCH SILNIKACH CHYBA CO NIE HMMM. */}

## What to expect?

After completing this tutorial, you will have a fully operational Leo Rover
equipped with BLDC motor-driven wheels {/* TODO: MOŻE FOTA? */}
...
{/* TODO: PEWNIE KOMPLET WYLISTOWAĆ TUTAJ */}
...
system.
{/* TODO: PODMIENIĆ NA LINK DO OS */}
Simply download the image, flash it onto the SD card, and insert it into
the robot.
...
in real time. {/* TODO: DODAĆ SCREEN JAK ZROBIE */}
...
- **`pid_constants`** (type: `float[]`, default: `[0.2, 0.5, 0.0]`)  
  ...
  :::warning This is one of the most critical parameters, as it significantly
  affects how the rover drives.  
