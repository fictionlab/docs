...
[this guide](/leo-rover/1.8/advanced-guides/ros-development#building-additional-ros-packages)).
...
[this guide](/leo-rover/1.8/advanced-guides/ros-development#connecting-another-computer-to-ros-network).
