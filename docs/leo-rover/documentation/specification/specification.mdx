...
<details>
  <summary>Specifications for previous versions of the Leo Rover</summary>

This is a technical specification of the Leo Rover 1.9. <br /> If you are
looking for specification of the older version of the Leo Rover, please visit:
...
<LinkButton docId="leo-rover/documentation/getting-started" />
