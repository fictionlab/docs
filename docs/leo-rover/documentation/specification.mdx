...
<table>
  ...
  <tbody>
    ...
    <tr>
      <td>IMU Filter</td>
      <td>
        Processes raw IMU data using a complementary filter to compute orientation.
        The node publishes filtered IMU messages with estimated orientation and RPY angles.
        It also enables calibration reset via a service.
      </td>
    </tr>
    <tr>
