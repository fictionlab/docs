...
| Motor Outputs | <ul><li>4x PWM H-bridge motor outputs (A, B, C, D)</li><li>Peak current: ±2.8 A</li><li>Overcurrent (OCP) and short-circuit protection (to power and GND)</li><li>5 V encoder supply (max 1 A total for all motors)</li><li>2× encoder inputs per motor (active low – short to GND)</li></ul> |
