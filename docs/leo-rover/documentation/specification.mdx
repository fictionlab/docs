...
Leo Rover's software heavily relies on The
...
<table>
  ...
  <tbody>
    <tr>
      <td>Firmware Node</td>
      <td>
        The node spawned by the LeoCore controller firmware. Allows controlling the robot's wheels
    ...
    <tr>
      ...
      <td>
        Provides a HTTP video streaming of ROS image topic for the Web User Interface.
      </td>
    </tr>
    <tr>
