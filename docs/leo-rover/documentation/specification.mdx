...
| Port                      | Functionality                                                                                                                                                                                                                                                                                 |
| ------------------------- | --------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- |
| **J1** - Power Input      | <ul><li>DC 2.1/5.0 mm barrel jack</li><li>Reverse polarity protection</li><li>Overvoltage protection</li><li>10 A fast-blow fuse</li><li>Input voltage: 8–30 V DC</li></ul>                                                                                                                   |
...
| **JP2** - Debug Port      | <ul><li>5-pin interface for firmware flashing via ST-Link/V2 (optional)</li></ul>                                                                                                                                                                                                             |
