...
<LinkButton
  to="/leo-integrations/software/aruco-tracking#generate-aruco-markers"
...
Update the `apt` and install the package **on the rover**:
...
The rover will start following the marker once it detects the ArUco marker with
a given ID.
