---
title: 'Leo Rover Example: How to Follow an Auco Marker'
...
# Example: How to Follow an ARTag

import LiteYouTubeEmbed from 'react-lite-youtube-embed';

An Aruco Marker follower example for a stock Leo Rover
...
- You can generate and download an Aruco marker from
  ...
  linked below. It gives you more controll regarding marker size and other
  parameters, which might be preferable for most of users.
...
printed marker on the peace of paper, but we do recommend, to attach it to some
...
the requrements you need to follow the configuration instructions.
...
Beeing connected and having ROS installed, next you have to source the `ROS`
workspace:
...
[object detection](/leo-rover/1.8/leo-examples/object-detection)), or try other
