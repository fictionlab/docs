...
- [Powerbox](/leo-rover/1.8/addons/powerbox) (recommended)
  <Powerbox />
...
provide the `input_topic` param with the namespace. Make sure that the
provided topic name is in the global namespace - starting with `/`,
e.g. `/namespace/merged_odom`.
