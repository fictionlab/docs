...
If you bought the integration from us, you can use the mounting adapter included in
the package. It is designed to mount the [sensor/component] on [location] of the
rover.
...
yourself. Get the files from the [Addon Adapters](../addon-adapters#[adapter-anchor]) page.
