...
Some USB-UART adapters allow you to choose the baud rate. 
If your adapter allows such setting, make sure that the setting is correct for your type of RPlidar.
