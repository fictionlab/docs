...
Some USB-UART adapters allow you to choose the baud rate. If your adapter has
this option, make sure that the switch is set to 115200 bps. An incorrectly set
baud rate may cause problems with receiving LiDAR data.
