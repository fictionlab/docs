...
image: /img/robots/leo/integrations/rplidar-a2/RPlidar_A2_integration_leo_iso_shot.webp
---
...
<ImageZoom
  ...
  alt="Leo Rover with mounted RPLidar A2"
  width="4000"
  height="3000"
/>
...
[Addon Adapters](../addon-adapters#rplidar-a2-adapter) page.
...
Make sure that excess cable is wrapped around the sensor so it does not obstruct
