...
Some USB-UART adapters allow you to choose the baud rate with a physical switch.
If your adapter has such a switch, make sure to put it in the correct position
for your RPLidar:
...
<Tabs groupId='lidar_version'>
    <TabItem value='m8' label='RLidar A2 M8'>
    ...
    <TabItem value='m12' label='RPLidar A2 M12' default='true'>
    ```xml title="/etc/ros/laser.launch.xml"
    <launch>
      <node pkg="rplidar_ros" exec="rplidar_node">
        <param name="serial_port" value="/dev/lidar"/>
