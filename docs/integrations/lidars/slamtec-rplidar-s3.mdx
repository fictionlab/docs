...
To avoid the cable getting in the way of the sensor's field of view, you can use
a right-angle adapter for the USB-C port or use the
[easy access cover for the main electronics box](/leo-rover/addons/additional-meb-covers#00188_dev---easy-access-cover)
and wire the cables without using the USB-C port on top of the rover.
