...
<LinkButton
  to="/leo-rover/advanced-guides/ros-development#expanding-the-urdf-model"
...
Now your Oak-D camera ROS node will start at launch.
...
You can also just start RViz (`rviz2` command), and add **robot model** in the
**display** view. Chose also `base_link` as **fixed frame**, and you should see
the rover model with camera attached.
