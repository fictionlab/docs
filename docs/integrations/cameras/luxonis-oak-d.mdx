...
The USB port placed on the mounting plate of the rover supports USB 3.0 which
means you can connect the camera directly to this port without additional
modifications.

:::warning

That is not true for Leo Rover robot version 1.8 and below. If you have this
model, you have to follow one of the approaches presented below.

:::

Alternatively you can connect the USB-C wire straight to the USB ports of the
rovers built-in Raspberry Pi.
