...
[additional computer](/integrations/computing-devices/nvidia-jetson) on your
rover, which supports **CUDA** operations (for example **NVIDIA Jetson**), has
internet connection, and ROS installed (on your and the rover computers).
