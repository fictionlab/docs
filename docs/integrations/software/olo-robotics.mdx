...
appliance** on the Leo Rover. The appliance runs in Docker, links the robot to the
...
You should see the appliance connect to the OLO backend and discover the Leo Rover's
ROS 2 topics.
